...
public class DebtDaoImpl implements DebtDao{
    ...
    public List getDebts(String familyId) {
        ...
        String sql = "select * from t_debt d,t_user u where d.family_id = ? and d.family_id = u.family_id and d.user_id = u.id order by borrow_date desc";
    ...
    public List getCreditors(String familyId) {
        jt = (JDBCTemplate) ObjectFactory.getObject("jdbcTemplate");
        String sql = "select * from t_creditor d,t_user u where d.family_id = ? and d.family_id = u.family_id and d.user_id = u.id order by lend_date desc";
        return jt.query(sql,familyId);
    }
